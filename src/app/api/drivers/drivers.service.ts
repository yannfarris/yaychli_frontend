...
export class DriversService {
  ...
  new(data: any) {
    ...
    return this.http
      .post(`${this.settings.apiUrl}/driver`, body, { headers: headers })
  ...
  getAllLite() {
    ...
    return this.http
      .get(`${this.settings.apiUrl}/driver/lite`)
  ...
  getAll() {
    ...
    return this.http
      .get(
        `${this.settings.apiUrl}/driver${this.apiQuery.getApiQuery().apiQuery}${this.apiQuery.getApiQuery().sortQuery}${this.apiQuery.getApiQuery().userQuery}`
      )
  ...
  delete(id: string) {
    ...
    return this.http
      .delete(`${this.settings.apiUrl}/driver?id=${id}`)
  ...
  changeStatus(id: string, state: string) {
    ...
    return this.http
      .post(`${this.settings.apiUrl}/driver/status`, body, { headers: headers })
